    ...
    <footer className="bg-gray-900 text-white pt-16 pb-8 mt-2">
      <div className="container px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="mb-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="font-primary text-2xl font-bold">
                  Road<span className="text-primary">Pedal</span>
                </span>
              </div>
              <p className="text-gray-400 font-secondary mb-6">
                Especialistas en soluciones integrales para ciclistas. Reparación, mantenimiento y venta de bicicletas y
                accesorios.
              </p>
            </div>
          ...
          <div>
            <h4 className="font-primary text-lg font-bold mb-6 pb-2 border-b border-gray-800">Servicios</h4>
          ...
          {/* Columna 3: Horarios */}
          <div>
            <h4 className="font-primary text-lg font-bold mb-6 pb-2 border-b border-gray-800">Horario de atención</h4>
            <ul className="space-y-3 font-secondary">
            ...
            <div className="mt-8">
              <h4 className="font-primary text-lg font-bold mb-4">Servicio a domicilio</h4>
              <p className="text-gray-400 font-secondary text-sm">
                Disponible de lunes a viernes. Agenda tu cita con 24h de anticipación.
              </p>
            </div>
          </div>
          ...
          {/* Columna 4: Contacto */}
          <div>
            <h4 className="font-primary text-lg font-bold mb-6 pb-2 border-b border-gray-800">Contáctanos</h4>
            <ul className="space-y-4 font-secondary">
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <span className="text-white">Av. Ciclista 123, Ciudad Deportiva</span>
                </div>
              </li>
              ...
              <li className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <span className="text-white">info@roadpedal.com</span>
                </div>
              </li>
            </ul>
            ...
            <a
              ...
              className="mt-6 inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white font-semibold py-3 px-6 rounded-lg transition-colors"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="text-gray-400 font-secondary text-sm">
            <p>&copy; {new Date().getFullYear()} roadpedal. Todos los derechos reservados.</p>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800">
          <p className="text-gray-400 font-secondary text-center mb-4">Métodos de pago aceptados</p>
          <div className="flex justify-center gap-4 flex-wrap">
            {["Visa", "Mastercard", "PayPal", "Apple Pay", "Google Pay"].map((method) => (
              <div key={method} className="bg-gray-800 px-4 py-2 rounded-lg">
                <span className="text-gray-300 font-secondary text-sm">{method}</span>
              </div>
            ))}
          </div>
        </div>
