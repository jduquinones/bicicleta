...
const bicicletaNueva = [
  {
    ...
    imagenes: ["/img/2/1.webp", "/img/2/2.webp"],
  },
];
          ...
          >
            ...
            <motion.div className="space-y-6" variants={itemVariants}>
              ...
              <motion.div className="flex items-center gap-4" variants={itemVariants}>
                <span className="text-3xl font-bold text-gray-600 font-secondary">${nueva.precio}</span>
                <motion.span
              ...
              <motion.div className="space-y-3" variants={itemVariants}>
                <h4 className="text-dark font-bold tracking-wide font-oxanium">ESPECIFICACIONES</h4>
                <motion.p
              ...
              <motion.div className="space-y-4" variants={itemVariants}>
                <h4 className="text-lg font-semibold text-dark tracking-wide font-oxanium">COLORES</h4>
                  ...
                  {nueva.colores.map((color, index) => (
                    <motion.button
                      ...
                      className={`w-12 h-12 rounded-full border-2 transition-all duration-300 ${
                        color.valor === "green"
                          ? "bg-green-800 border-green-950 shadow-lg scale-110"
                          : color.valor === "black"
